...
settingsFields.llm.splice(4, 0,
  ...
  { key: 'FAST_ROUND_MAX_TOKENS', label: 'Fast pass maximum output tokens (64–768)', type: 'number' },
  { key: 'FAST_ROUND_TIMEOUT_SECONDS', label: 'Fast pass maximum elapsed time (seconds, 1–30)', type: 'number' },
);
